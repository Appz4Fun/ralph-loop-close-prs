...
def _validate_pr_metadata(
    ...
    # Prevent git argument injection by rejecting branch names starting with hyphens
    if branch.startswith("-"):
        raise CommandError("Invalid PR head branch name: cannot start with a hyphen.")
    if expected_base.startswith("-") or (pr_base and pr_base.startswith("-")):
        raise CommandError("Invalid PR base branch name: cannot start with a hyphen.")
