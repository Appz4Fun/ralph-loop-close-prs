...
def _filter_to_still_open_prs(pr_numbers: List[int]) -> List[int]:
    ...
    kept: List[int] = []
    # Performance optimization: Use ThreadPoolExecutor for concurrent polling
    # Expected impact: Prevents N+1 polling delays scaling as O(N) when verifying many PRs
