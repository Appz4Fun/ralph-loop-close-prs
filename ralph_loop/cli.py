...
def _filter_to_still_open_prs(pr_numbers: List[int]) -> List[int]:
    ...
    # ⚡ Bolt Optimization: Use ThreadPoolExecutor to run gh subprocesses concurrently
    # This avoids N+1 sequential execution delays when checking states for multiple PRs.
