...
def _filter_to_still_open_prs(pr_numbers: List[int]) -> List[int]:
    ...
    # This avoids N+1 delays from sequential GitHub CLI subprocess calls.
    # Expected impact: Significantly reduces the time to check multiple PRs (from O(N) to O(N/workers)).
