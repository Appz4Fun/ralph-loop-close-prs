...
def _filter_to_still_open_prs(pr_numbers: List[int]) -> List[int]:
    ...
    # This prevents the N+1 sequential subprocess execution delay for gh pr view,
    # significantly reducing the fan-out spin-up time.
    def _check(pr: int) -> Tuple[int, bool, Any]:
        try:
