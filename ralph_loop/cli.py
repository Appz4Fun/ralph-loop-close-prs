...
def _filter_to_still_open_prs(pr_numbers: List[int]) -> List[int]:
    ...
    # Evaluate PR states concurrently. `gh pr view` takes ~1s per call.
    # Processing N PRs sequentially creates an N-second N+1 query delay.
    # Executing concurrently reduces this bound to ~1 second total.
