...
def _filter_to_still_open_prs(pr_numbers: List[int]) -> List[int]:
    ...
    # OPTIMIZATION: Concurrently check PR states to avoid N+1 GitHub CLI calls delay.
    # Expected impact: Significantly reduces latency when fanning out across multiple PRs.
